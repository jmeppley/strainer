 ...
 * Genbank file.
 *
 * This version was modified from biojava 1.4 to be a little more forgiving of 
 * GenBank file formats. Locus lines between 75 and 79 chars are now just parsed 
 * for the first element after "LOCUS"
 * 
 * Search for "modified by JME" in source to find modifications.
 *
 * @author Thomas Down
 * @author Greg Cox
 * @author John Eppley
...
//	this.symbols = new ArrayList();
    	...
    	throws ParseException
    {
        ...
        {
        		// modified by JME
        		// code copied from parseLocusLinePre127() case where line <75 chars
        		//  (just get locus name)
            StringTokenizer locusTokens = new StringTokenizer(theLine);
            //Locus Tag
            locusTokens.nextToken();
